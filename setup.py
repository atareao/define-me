...
DATA_FILES = [
	('/opt/extras.ubuntu.com/define-me/bin',glob.glob('bin/*')),
	('/opt/extras.ubuntu.com/define-me/share/define-me',glob.glob('src/*')),
	('/opt/extras.ubuntu.com/define-me/share/define-me',['debian/changelog']),	
	('/opt/extras.ubuntu.com/define-me/share/pixmaps',['data/define-me.svg']),
	('/usr/share/applications',['data/define-me.desktop'])
	]
...
class install_data(_install_data):
	def run(self):
		for lang in os.listdir('build/locale-langpack/'):
			lang_dir = os.path.join('/opt/extras.ubuntu.com/define-me/share', 'locale-langpack', lang, 'LC_MESSAGES')
